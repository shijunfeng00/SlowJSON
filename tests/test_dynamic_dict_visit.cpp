...
void test_dynamic_dict_visit() {
    ...
    assert_with_message(dict["v"].is_list(), "v 键应为数组");
    ...
    assert_with_message(dict["list"].is_list(), "list 键应为数组");
    ...
    assert_with_message(dict["list"].is_list(), "list 类型应为 list");
