...
namespace slow_json {
    ...
    struct DumpToString<dict>:public IDumpToString<DumpToString<dict>>{
        static void dump_impl(Buffer&buffer,const dict&object)SLOW_JSON_NOEXCEPT{
            if(object.value_type()==details::serializable_wrapper::ROOT_DICT_TYPE) {
                buffer += '{';
            ...
            }else if(object.value_type()==details::serializable_wrapper::DICT_TYPE){
                buffer += '{';
                auto &real_object = *static_cast<dict*>(object._data_ptr->value());
                DumpToString<details::dict>::dump(buffer,real_object);
                ...
                auto&v=*static_cast<details::serializable_wrapper*>(object._data_ptr);
                DumpToString<details::serializable_wrapper>::dump(buffer,v);
